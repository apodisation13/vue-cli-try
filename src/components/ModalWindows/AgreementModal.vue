<template>
  <div class="wrapper_modal" @click.stop="hideModal">
    <div @click.stop class="modal">
      <img class="close-btn" src="@/assets/icons/buttons/x-circle.svg" @click="hideModal"/>
      <h2 class="header">Пользовательское соглашение</h2>
      <div class="content">
        <ol>
          <li>
            <span class="uppercase">Определение понятий</span>
            <p>В тексте настоящего Соглашения нижеизложенным терминам дано
              следующее значение: </p>
            <p><strong>"Компания", "Мы", "Наш", "Нас", "Нами"</strong> или какие-либо другие схожие
              производные (в зависимости от контекста) означает следующее лицо: TEAM
              "12 PEOPLE", адрес местонахождения: Российская Федерация, г.Москва
              (включая, его филиалы и представительства как на территории Российской
              Федерации, так и за ее пределами, а также какие-либо другие лица,
              созданные в результате реорганизации Компании), которые являются
              владельцами Приложения или им управляют.</p>
            <p><strong>"Контент приложения"</strong> означает все объекты, размещенные Компанией
              ...
              виртуальные объекты, видео, персонажи, темы, имена персонажей,
              сюжетные линии, диалоги, настройки, звуковые эффекты, программы,
              музыка, звуки, информация, уведомления и какие-либо другие схожие
              объекты, их подборки или комбинации.</p>
            <p><strong>"Обновления"</strong> означает программный патч или программный пакет для
              ...
              безопасности и совместимости Приложения с устройствами.</p>
            <p><strong>"Платформа"</strong> означает облачную платформу, на которой Компания
              разместила Приложение для его последующего скачивания Пользователем.
              Настоящее Приложение доступно для скачивания из Google Play.</p>
            <p><strong>"ПО приложения"</strong> означает программное обеспечение, разработанное
              ...
              (HTML коды), программы и тп.</p>
            <p><strong>"Пользователь", "Вы", "Ваш", "Вас", "Вами"</strong> или какие-либо другие схожие
              ...
              тексте данного Соглашения, путем проставления специальной галочки при
              открытии Приложения.</p>
            <p><strong>"Приложение"</strong> означает следующее приложение: Twelve, которое
              Пользователь загружает через Платформу на смартфон или другое
              устройство.</p>
            <p><strong>"Услуги"</strong> означает совокупно Контент приложения и ПО приложения.</p>
            <p><strong>"In-app покупка"</strong> означает получение Пользователем за плату
              дополнительных возможностей и/или функционала для Приложения и/или
              приобретение каких-либо виртуальных товаров/услуг в рамках Приложения.</p>
          </li>
          <li>
            <span class="uppercase">Присоединение к соглашению</span>
            <p><strong>Общие положения</strong></p>
            <ol>
              <li>Настоящее Пользовательское соглашение (далее <strong>"Соглашение"</strong>)
                ...
                при получении доступа к Приложению и Услугам.</li>
              <li>Пользователь принимает условия данного Соглашения путем
                проставления специальной галочки в отведенном поле при загрузке
                Приложения на смартфон или другое устройство.</li>
              <li>Данное Соглашение является обязательным для его сторон (т.е. для
                ...
                письменного согласия от Компании.</li>
              <li>Если Вы являетесь законным представителем (родителем, опекуном)
                ...
                Пользователя на условия данного Соглашения.</li>
              <p><strong>Предупреждение для пользователей</strong></p>
              <li>Если Пользователь осуществляет доступ к Приложению и/или его
                ...
                такой Платформы или социальной сети.</li>
              <li>Пользователь признает, что его соглашение с провайдером мобильной
                сети (далее <strong>"Провайдер"</strong>) будет применяться к использованию
                ...
                плательщика счета на использование Приложения.</li>
              <li>Пользователь является единственным ответственным лицом за проверку
          ...
          <li>
            ...
            <ol>
              <li>Для использования Приложения Пользователи должны соответствовать
              ...
              <li>Пользование Услугами возможно как Пользователями, которые прошли
                процедуру создания личного аккаунт (кабинета), так и Пользователями,
                которые отказались от такого создания. Незарегистрированные
                Пользователи не имеют доступа к следующим Услугам:<br>
                <em>Доступ к полному контенту игры (уровни, карты)</em>
              </li>
              <li>Для снятия указанных ограничений и получения полного доступа
                Пользователю необходимо создать свой личный аккаунт (кабинет). По
                результатам завершения регистрации Пользователь получает уникальный
                логин и пароль.</li>
              <li>Действие данного Соглашения распространяется одинаково в полном
                объеме (без каких-либо исключений) как на Пользователей с личным
                аккаунтом (кабинетом), так и без него.</li>
              <li>Для создания личного аккаунта (кабинета) Пользователю необходимо
          ...
          <li>
            ...
            <ol>
              <li>Пользователь получает неисключительную, без права передачи и
                сублицензии, <span class="uppercase">только</span> для личного (некоммерческого) пользования лицензию
                на Услуги (далее <strong>"Пользовательская лицензия"</strong>). Пользователь берет на
                себя обязательство не использовать Услуги в каких-либо других целях.
                Пользователь получает указанную Пользовательскую лицензию <span class="uppercase">только</span> при
                условии соблюдения <span class="uppercase">всех</span> условий данного Соглашения.</li>
              <li>Пользовательская лицензия прекращает действовать автоматически при
                ...
                предоставлена выше.</li>
                <p><strong>Интеллектуальная собственность компании</strong></p>
              <li>Компании принадлежат все без исключения права собственности,
                ...
                объектов интеллектуальной собственности.</li>
              <li><span class="uppercase">Пользователям запрещено</span> копировать, воспроизводить,
                ...
                кроме случаев, когда такие действия <span class="uppercase">прямо</span> разрешены условиями данного
                Соглашения или действующим законодательством Российской Федерации.</li>
              <li>Ничто в тексте данного Соглашения не может быть истолковано как
                передача Пользователю каких-либо исключительных прав на Контент
                приложения (полностью или в отдельной части) и/или ПО приложения.</li>
              <li>Компания владеет всеми правами в отношении торговых марок,
                коммерческих (бизнес) наименований, брендов, логотипов,
                зарегистрированных на ее имя (далее <strong>"Торговые марки"</strong>). Такие Торговые
                ...
                лицензии Пользователю на использование таких Торговых марок.</li>
            </ol>
          </li>
          <li><span class="uppercase">Порядок работы с приложением</span>
            <p><strong>Общие положения</strong></p>
            <ol>
              <li>Пользователь обязуется соблюдать следующие правила при работе с
                Приложением:<br>
                <b>(1)</b> соблюдать все обязательства, взятые на себя Пользователем в связи с
                присоединением к данному Соглашению; и<br>
                <b>(2)</b> предоставлять достоверные о себе данные для создания личного
                аккаунта (кабинета); и<br>
                ...
                для создания личного аккаунта (кабинета); и<br>
                <b>(4)</b> информировать Компанию о хищении логинов, паролей или какихлибо других ключей доступа Пользователя к
                личному аккаунту
                (кабинету); и<br>
                <b>(5)</b> не предоставлять третьим лицам доступ к своему аккаунту
                (кабинету) и/или логины, пароли или другие ключи доступа; и<br>
                <b>(6)</b> не совершать какие-либо действия (с использованием средств
                автоматизации или без таких средств), направленные на сбор каких-либо
                персональных данных других Пользователей; и<br>
                <b>(7)</b> не предпринимать какие-либо действия и не помогать третьим лицам
                ...
                <b>(8)</b> не предпринимать какие-либо иные действия, которые являются
                незаконными, мошенническими, дискриминационными или вводящими в
                заблуждение.</li>
              <li>Услуги время от времени могут включать в себя какие-либо виртуальные
                объекты, которые в течение игры может "зарабатывать"/получать
                Пользователь. Пользователь настоящим считается должным образом
                уведомлен, что такие виртуальные объекты <b>(1)</b> существуют исключительно в
                рамках Приложения и не предназначены для использования в реальной
                жизни; и <b>(2)</b> не имеют никакой другой ценности/стоимости кроме той,
                которую они имеют в игре; и <b>(3)</b> Компания может в любой момент без какого-либо предварительного
                уведомления
                удалить, обнулить, изменить и/или
                модифицировать их без предварительного уведомления и/или
                предоставления какой-либо компенсации Пользователю.</li>
              <li>Компания освобождает себя от какой-либо ответственности за вред,
                убытки, упущенную выгоду, потерю репутации и/или какой-либо иной ущерб,
                причиненный Пользователю потерей, проигрышем, удалением, обнулением,
                исчезновением каких-либо виртуальных объектов вследствие <b>(1)</b>
                технической неисправности или сбоя в работе Приложения, или <b>(2)</b>
                установления Обновлений, или <b>(3)</b> удаления аккаунта Пользователя в связи с
                нарушением им условий данного Соглашения, или <b>(4)</b> удаления
                Пользователем Приложения на смартфоне или другом устройстве.</li>
                <p><strong>Отзывы о работе приложения</strong></p>
              <li>Каждый Пользователь время от времени имеет право (но не обязанность)
                ...
                Пользователем следующим способом:<br>
                <i>Отправить письмо по след. адресу:</i><br>
                <em>twelvepeoplegame@gmail.com</em></li>
              <li>В случае направления такой идеи, отзыва, предложения или проекта
                ...
                основе.</li>
              <li>Любая такая информация, предоставляемая Компании, автоматически
                признается неконфиденциальной.</li>
            </ol>
          </li>
          <li><span class="uppercase">Размещение рекламы в приложении</span>
            <p><strong>Размещение рекламы компанией</strong></p>
            <ol>
              <li>Компания имеет право время от времени размещать какие-либо
                рекламные или маркетинговые материалы.</li>
                <p><strong>Размещение рекламы третьими лицами</strong></p>
              <li>Контент приложения может содержать ссылки на веб-сайты третьих лиц
                и/или рекламные или маркетинговые материалы о товарах/услугах,
                предоставляемых такими третьими лицами (далее <p><strong>"Реклама третьих лиц"</strong></p>).
                ...
                товаров/услуг.</li>
              <li>В случае перехода на другой сайт через размещенную Рекламу третьих
                ...
                третьих лиц.</li>
              <li>Вопросы, связанные с защитой персональных данных Пользователей при
                использовании ими Рекламы третьих лиц, регулируются Политикой
                конфиденциальности приложения.</li>
            </ol>
          </li>
          <li><span class="uppercase">Проведение оплаты через приложение</span>
            <ol>
              <li>Приложение не предоставляет возможность покупки каких-либо
                товаров/услуг через него.</li>
            </ol>
          </li>
          <li><span class="uppercase">Совершение In-App покупок</span>
            <ol>
              <li>Совершение каких-либо In-app покупок внутри Приложения не
                предусмотрено.</li>
            </ol>
          </li>
          <li><span class="uppercase">Доступ к приложению</span>
            <p><strong>Общие положения</strong></p>
            <ol>
              <li>Компания оставляет за собой право изменить или модифицировать
                ...
                Приложения.</li>
              <li>Компания не гарантирует, что Приложение и Услуги будут доступными
                ...
                работу Приложения без остановок и сбоев.</li>
                <p><strong>Предоставление обновлений</strong></p>
              <li>Компания время от времени может предоставлять Обновления и
                ...
                к Услугам и/или их Обновлениям.</li>
                <p><strong>Удаление аккаунта</strong></p>
              <li>Пользователь имеет право в любой момент прекратить использование
                Приложения посредством удаления его со своего смартфона или другого
                устройства.</li>
              <li>В случае <b>(1)</b> нарушения Пользователем условий настоящего Соглашения
                ...
                Приложении в будущем.</li>
              <li>Во всех случаях удаления аккаунта Пользователя или удаления
                ...
                ответственность за удаление таких данных и информации, а также за какойлибо вред, ущерб, убытки или
                упущенную
                выгоду, причиненную
          ...
          <li><span class="uppercase">Задать вопрос</span>
            <ol>
              <li>Если у Вас есть вопросы касательно условий настоящего Соглашения
                или порядка/способа их исполнения, Вы можете адресовать нам свой вопрос
                следующим способом:<br>
                <i>Отправить письмо по след. адресу:</i><br>
                <em>twelvepeoplegame@gmail.com</em></li>
              <li>Сотрудники и представители Компании обязуются предпринять все
                возможные усилия для дачи ответа на Ваш запрос в течение разумного
                периода времени.</li>
            </ol>
          </li>
          <li><span class="uppercase">Ответственность</span>
            <ol>
              <li>Ни при каких обстоятельствах компания или ее представители
                ...
                Соглашения или нормой действующего законодательства.</li>
              <li>Наша ответственность за все что угодно, связанное с использованием
                Приложения и/или Услуг, ограничивается настолько сильно, насколько это
                допускается действующим законодательством.</li>
            </ol>
          </li>
          <li><span class="uppercase">Порядок разрешения споров</span>
            <ol>
              <li>В случае возникновения любых споров или разногласий, связанных с
          ...
          <li><span class="uppercase">Заключительные положения</span>
            <ol>
              <li>Мы можем время от времени пересматривать, дополнять или изменять
                ...
                Компания обязуется уведомить Пользователей за 10 календарных дней до
                ...
                без каких-либо возражений.</li>
              <li>Если иное прямо не указано в положениях настоящего Соглашения или
                ...
                Федерации.</li>
              <li>Неотъемлемой частью настоящего Соглашение является Политика
                конфиденциальности приложения.</li>
              <li>Если одно или несколько условий данного Соглашения утратило свою
                ...
                утратившим юридическую силу условия не существовало вовсе.</li>
              <li>Доступ к Приложению и его Услугам предоставляется Пользователю
