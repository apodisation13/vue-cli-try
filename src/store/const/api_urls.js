...
export const craft_card = 'https://card-game.ru/api/v1/patchcards/craft_user_cards/'
export const mill_card = 'https://card-game.ru/api/v1/patchcards/mill_user_cards/'
export const craft_leader = 'https://card-game.ru/api/v1/patchleaders/craft_user_leaders/'
export const mill_leader = 'https://card-game.ru/api/v1/patchleaders/mill_user_leaders/'
